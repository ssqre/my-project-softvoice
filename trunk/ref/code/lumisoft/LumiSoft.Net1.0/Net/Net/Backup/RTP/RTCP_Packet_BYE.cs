    ...
    public class RTCP_Packet_BYE : RTCP_Packet
    {
        ...
        protected override void ParseInternal(byte[] buffer,ref int offset)
        {
            ...
            */
            ...
            m_Sources = new int[sourceCount];
            for(int i=0;i<sourceCount;i++){
                m_Sources[i] = buffer[offset++] << 24 | buffer[offset++] << 16 | buffer[offset++] << 8 | buffer[offset++];
            }
        ...
        /// <summary>
        /// Gets SSRC/CSRC identifiers included in this BYE packet.
        /// </summary>
        public int[] Sources
        {
